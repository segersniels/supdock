...
exports.docker = (options) => {
    const args = ((typeof options === 'undefined') ? process.argv.slice(2) : options);
    execute('docker', args);
}
...
exports.executeCompose = async (question, action, error) => {
    if (typeof action === 'undefined') console.error('supdock: no action was specified');
    else {
